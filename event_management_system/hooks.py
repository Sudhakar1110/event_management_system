...
app_description = "Event Booking Platform (Wedding Halls, Photographers, Decorators, Caterers, Makeup Artists, Event Planners, DJs, Flower Decorators, Transportation Services, and other event-related vendors"
app_email = "sudhakarsathiyamoorthy@gmail.com"
app_license = "mit"
